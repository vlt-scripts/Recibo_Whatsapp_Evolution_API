...
$cronComando = "/usr/bin/php -q /opt/mk-auth/admin/addons/Recibo_Evolution/limpar_tabela.php $intervaloDias > /dev/null 2>&1";
...
foreach ($linhasCron as $linha) {
    if (strpos($linha, '/opt/mk-auth/admin/addons/Recibo_Evolution/limpar_tabela.php') === false) {
