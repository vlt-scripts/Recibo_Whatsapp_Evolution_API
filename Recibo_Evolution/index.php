...
function atualizarCronEnvioZap($intervaloMinutos) {
    global $cronFilePath;
    $comandoEnvioZap = "/usr/bin/php -q /opt/mk-auth/admin/addons/Recibo_Evolution/enviozap.php >/dev/null 2>&1";
    
    // Verifica se o agendamento de envio já existe
    $cronAtual = shell_exec("crontab -l | grep -v '/opt/mk-auth/admin/addons/Recibo_Evolution/enviozap.php'");
...
function obterAgendamentoAtual() {
    $output = shell_exec("crontab -l | grep '/usr/bin/php -q /opt/mk-auth/admin/addons/Recibo_Evolution/enviozap.php'");
...
function obterLimpeza() {
    $output = shell_exec("crontab -l | grep '/usr/bin/php -q /opt/mk-auth/admin/addons/Recibo_Evolution/limpar_tabela.php'");
...
function excluirAgendamentoEnvioZap() {
    shell_exec("crontab -l | grep -v '/usr/bin/php -q /opt/mk-auth/admin/addons/Recibo_Evolution/enviozap.php' | crontab -");
...
function excluirAgendamentoLimpeza() {
    shell_exec("crontab -l | grep -v '/usr/bin/php -q /opt/mk-auth/admin/addons/Recibo_Evolution/limpar_tabela.php' | crontab -");
